      ...
      <div style={{ paddingTop:'var(--nav-h)', minHeight:'100vh', background:'white' }}>
        ...
        <div className="redeem-hero">
          ...
          <div style={{ position:'relative' }}>
            ...
            <p style={{ fontSize:14, color:'rgba(255,255,255,0.4)', maxWidth:440, lineHeight:1.6, marginBottom:20 }}>
              Exchange your points for exclusive products, grading services, and merch. Every Rp 100,000 = 1 point.
            </p>
            <div style={{ display:'flex', alignItems:'center', gap:12, flexWrap:'wrap' }}>
              <Link href="/vault" style={{ display:'inline-flex', alignItems:'center', gap:6, background:'var(--gold)', color:'var(--black)', textDecoration:'none', padding:'10px 20px', borderRadius:8, fontSize:13, fontWeight:700 }}>
                Check My Points →
              </Link>
                    ...
                    <div style={{ padding:16 }}>
                      ...
                      <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between' }}>
                        ...
                        {p.stock !== undefined && p.stock <= 5 && (
                          <div style={{ fontSize:10, color:'var(--red)', fontWeight:600 }}>⚠️ {p.stock} left</div>
                        )}
                      </div>
                    </div>
                  </div>
